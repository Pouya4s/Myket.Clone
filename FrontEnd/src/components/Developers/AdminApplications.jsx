              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="h-[50px]">
                    ...
                    <td colSpan={2}>
                    <button type="submit" className="bg-[#0d36ff] p-1.5 px-5 rounded-md mt-3 mx-2">اضافه کردن</button>
                    </td>
                  </tr>
                </tbody>
              </table>
              ...
              <table className="w-full">
                <tbody>
                  ...
                  <tr className="h-[50px]">
                    ...
                    <td>
                      <input style={{direction:"ltr"}} name="downloadsCount" value={DCount} type="number" className="rounded px-2 py-1 text-[#222] w-full" onChange={(e)=>{setDCount(e.target.value)}}/>
                    </td>
                    <td>
                      <label className="px-3">اندازه (mb)</label>
                    </td>
                  ...
                  <tr className="h-[50px]">
                    ...
                    <td>
                      <button type="submit" className="bg-[#ff7800] text-[#181818] hover:text-[#000] font-bold p-1.5 px-3 rounded-md mt-3 mx-2">ویرایش</button>
                    </td>
                    <td>
